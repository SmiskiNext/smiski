...
const AVATAR_PALETTE = ['#0052CC', '#00875A', '#FF8B00', '#6554C0', '#DE350B', '#00A3BF'];
...
export const MOCK_USERS: MockUser[] = [
  ...
  { accountId: 'acc-bao-tran', displayName: 'Bao Tran', avatarUrl: initialsAvatar('Bao Tran', 2) },
  {
    accountId: 'acc-chi-nguyen',
    displayName: 'Chi Nguyen',
    avatarUrl: initialsAvatar('Chi Nguyen', 3),
  },
  { accountId: 'acc-minh-le', displayName: 'Minh Le', avatarUrl: initialsAvatar('Minh Le', 4) },
  { accountId: 'acc-sara-kim', displayName: 'Sara Kim', avatarUrl: initialsAvatar('Sara Kim', 5) },
  {
