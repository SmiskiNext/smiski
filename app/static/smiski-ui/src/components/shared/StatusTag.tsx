...
const RECORDING_STATUS_CONFIG: Record<RecordingStatus, { className: string; text: string }> = {
  PENDING: {
...
function LiveDot() {
  return (
    <span aria-hidden="true" className="mr-1.5 size-1.5 animate-pulse rounded-full bg-current" />
  );
}
