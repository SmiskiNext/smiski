  ...
  const card = (
    ...
    >
      <header className="flex items-start justify-between gap-4 border-b px-5 py-4 sm:px-6">
        <div>
          <h2 id={titleId} className="text-lg font-bold tracking-tight text-[var(--text)]">
            {title}
          </h2>
      ...
      <div className="scrollbar-subtle flex-1 overflow-y-auto px-5 py-5 sm:px-6">{children}</div>
      {footer && (
