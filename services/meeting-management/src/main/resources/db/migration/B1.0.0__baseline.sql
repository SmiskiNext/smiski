...
CREATE TABLE recordings_p00 PARTITION OF recordings FOR VALUES WITH (MODULUS 16, REMAINDER 0);
CREATE TABLE recordings_p01 PARTITION OF recordings FOR VALUES WITH (MODULUS 16, REMAINDER 1);
CREATE TABLE recordings_p02 PARTITION OF recordings FOR VALUES WITH (MODULUS 16, REMAINDER 2);
CREATE TABLE recordings_p03 PARTITION OF recordings FOR VALUES WITH (MODULUS 16, REMAINDER 3);
CREATE TABLE recordings_p04 PARTITION OF recordings FOR VALUES WITH (MODULUS 16, REMAINDER 4);
CREATE TABLE recordings_p05 PARTITION OF recordings FOR VALUES WITH (MODULUS 16, REMAINDER 5);
CREATE TABLE recordings_p06 PARTITION OF recordings FOR VALUES WITH (MODULUS 16, REMAINDER 6);
CREATE TABLE recordings_p07 PARTITION OF recordings FOR VALUES WITH (MODULUS 16, REMAINDER 7);
CREATE TABLE recordings_p08 PARTITION OF recordings FOR VALUES WITH (MODULUS 16, REMAINDER 8);
CREATE TABLE recordings_p09 PARTITION OF recordings FOR VALUES WITH (MODULUS 16, REMAINDER 9);
CREATE TABLE recordings_p10 PARTITION OF recordings FOR VALUES WITH (MODULUS 16, REMAINDER 10);
CREATE TABLE recordings_p11 PARTITION OF recordings FOR VALUES WITH (MODULUS 16, REMAINDER 11);
CREATE TABLE recordings_p12 PARTITION OF recordings FOR VALUES WITH (MODULUS 16, REMAINDER 12);
CREATE TABLE recordings_p13 PARTITION OF recordings FOR VALUES WITH (MODULUS 16, REMAINDER 13);
