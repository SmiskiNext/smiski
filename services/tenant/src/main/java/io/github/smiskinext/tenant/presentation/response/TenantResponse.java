...
public record TenantResponse(
        ...
        @Schema(description = "Application version", example = "1.0.0") @Nullable String appVersion,

        @Schema(description = "Environment identifier", example = "env-1") @Nullable String environmentId,

        @Schema(description = "Atlassian site URL", example = "https://example.atlassian.net")
