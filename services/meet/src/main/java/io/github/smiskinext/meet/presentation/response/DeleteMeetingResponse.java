...
@Schema(description = "Snapshot of a soft-deleted meeting")
public record DeleteMeetingResponse(Meeting meeting) {

    @Schema(name = "DeletedMeetingSnapshot", description = "Deleted meeting snapshot")
    ...
    public static DeleteMeetingResponse from(DeleteMeetingResult result) {
        return new DeleteMeetingResponse(toMeeting(result));
    }

    static Meeting toMeeting(DeleteMeetingResult result) {
        return new Meeting(
                result.meetingId(),
                result.hostId(),
                result.shortCode(),
