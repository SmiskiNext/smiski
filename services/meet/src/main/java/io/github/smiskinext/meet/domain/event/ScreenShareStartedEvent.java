...
/**
 * Published when a participant starts sharing their screen (webhook: {@code track_published}
 * with a {@code SCREEN_SHARE} track source).
 *
 ...
 */
public record ScreenShareStartedEvent(
        UUID eventId,
        String tenantId,
        UUID meetingId,
        String accountId,
    ...
    public String eventType() {
        return "io.github.smiskinext.meet.screen_share.started.v1";
    }

    @Override
    public String topic() {
        return "meet.screen_share.started";
    }
}
