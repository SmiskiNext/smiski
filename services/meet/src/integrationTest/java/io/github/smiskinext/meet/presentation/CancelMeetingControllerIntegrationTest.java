...
class CancelMeetingControllerIntegrationTest {
    ...
    @Test
    void hostCancelReturnsCanceledSnapshotWithCancelReasonAndPersistsState() throws Exception {
    ...
    @Test
    void nonHostCancelIsForbiddenAndMeetingRemainsUnchanged() throws Exception {
        UUID meetingId = insert("SCHEDULED");
    ...
    @Test
    void cancelNonScheduledMeetingReturnsConflict() throws Exception {
