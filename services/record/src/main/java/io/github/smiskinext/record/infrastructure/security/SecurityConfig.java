package io.github.smiskinext.record.infrastructure.security;
 ...
 * trust this boundary and perform no token verification of their own. The LiveKit egress webhook
 * carries its own LiveKit signature and is likewise unaffected.
 */
@Configuration
@EnableWebSecurity
